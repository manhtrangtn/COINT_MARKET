...
namespace CointMarket.Services
{
    public class CoinService
    {
      ...
      public async Task<String> GetCryptocompareCoint(string coin)
      {
        HttpRequestMessage httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, "https://min-api.cryptocompare.com/data/pricemulti?fsyms="+coin+"&tsyms=USD");
        var resp = await _client.SendAsync(httpRequestMessage);
